...
class Roof:
    ...
    def __init__(self, roofRendererId, data, volumeAction, itemRenderers):
        ...
        # The variable below is used to check if a Geometry Node setup is available,
        # that can generate a desired volume with the related roof shape out of a footprint.
    ...
    def doFootprintOnly(self, footprint):
        ...
        verts = footprint.building.element.l.genFootprints.verts
        indexOffset = len(verts)
        polygon = footprint.polygon
        numVerts = polygon.numEdges

        verts.extend(Vector((v[0], v[1], 0.)) for v in polygon.verts)
        ...
        footprint.facades.extend(
            Facade(
                footprint,
                (indexOffset+i, indexOffset+i+1), # only indices of the lower facade edge
                vector,
                self
