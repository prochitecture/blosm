...
Code copied from Stanislav Kozlovski at https://github.com/stanislavkozlovski/Red-Black-Tree.
He didn't provide any license, so we assume we may use it here.
"""
    ...
    def _try_rebalance(self, node):
        ...
        if uncle == self.NIL_LEAF or uncle.color == BLACK:
            ...
            if general_direction == 'LL':
                ...
                # due to the previous rotation, our node is now the parent
                ...
                # due to the prevous rotation, our node is now the parent
